...
-- at runtime using the environment variable Taak_Augutus_bindir.
...
-- environment variable Taak_Augutus_libdir.
...
-- using the environment variable Taak_Augutus_dynlibdir.
...
-- runtime using the environment variable Taak_Augutus_datadir.
...
-- variable Taak_Augutus_libexedir.
...
-- using the environment variable Taak_Augutus_sysconfdir.
...
bindir     = "C:\\cabal\\bin"
libdir     = "C:\\cabal\\x86_64-windows-ghc-9.6.7\\Taak-Augutus-0.1.0.0-inplace-Taak-Augutus"
dynlibdir  = "C:\\cabal\\x86_64-windows-ghc-9.6.7"
datadir    = "C:\\cabal\\x86_64-windows-ghc-9.6.7\\Taak-Augutus-0.1.0.0"
libexecdir = "C:\\cabal\\Taak-Augutus-0.1.0.0-inplace-Taak-Augutus\\x86_64-windows-ghc-9.6.7\\Taak-Augutus-0.1.0.0"
sysconfdir = "C:\\cabal\\etc"

getBinDir     = catchIO (getEnv "Taak_Augutus_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "Taak_Augutus_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "Taak_Augutus_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "Taak_Augutus_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "Taak_Augutus_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "Taak_Augutus_sysconfdir") (\_ -> return sysconfdir)
