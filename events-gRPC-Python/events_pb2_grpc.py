...
class EventServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.GetEventsFromDay = channel.unary_unary(
                '/events.EventService/GetEventsFromDay',
                request_serializer=events__pb2.GetEventsRequest.SerializeToString,
                response_deserializer=events__pb2.GetEventsResponse.FromString,
...
def add_EventServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetEventsFromDay': grpc.unary_unary_rpc_method_handler(
                    servicer.GetEventsFromDay,
                    request_deserializer=events__pb2.GetEventsRequest.FromString,
                    response_serializer=events__pb2.GetEventsResponse.SerializeToString,
            ),
    }
...
class EventService(object):
    ...
    def GetEventsFromDay(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            events__pb2.GetEventsResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
