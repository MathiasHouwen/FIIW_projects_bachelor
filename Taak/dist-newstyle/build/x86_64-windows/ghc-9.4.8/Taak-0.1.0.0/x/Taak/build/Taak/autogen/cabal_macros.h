...
/* package Taak-0.1.0.0 */
#ifndef VERSION_Taak
#define VERSION_Taak "0.1.0.0"
#endif /* VERSION_Taak */
#ifndef MIN_VERSION_Taak
#define MIN_VERSION_Taak(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Taak */
...
#define CURRENT_COMPONENT_ID "Taak-0.1.0.0-inplace-Taak"
